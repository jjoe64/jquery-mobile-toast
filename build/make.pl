...
@files = (
	'jquery.mobile.toast.min.js',
	'jquery.mobile.toast.min.css');
...
if ( $ARGV[0] ) {
	...
	if ( $ARGV[0] eq 'clean' ) {
		...
		make_master();
		$last = (stat "../js/jquery.mobile.toast.js")[9];
...
sub make_master {
	...
	print "compressing... ";
	system($javapath, "-jar", "../external/yuicompressor-2.4.6.jar", "-o", "./jquery.mobile.toast.min.js", "../js/jquery.mobile.toast.js");
	print "DONE.\n";
	print "Build :-: CSS File... ";
	print "compressing... ";
	system($javapath, "-jar", "../external/yuicompressor-2.4.6.jar", "-o", "./jquery.mobile.toast.min.css", "../css/jquery.mobile.toast.css");
	print "DONE.\n";
}
